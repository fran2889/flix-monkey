...
- [ ] **Step 1: Remove design and plan documents**

```bash
cd /home/fran/Projects/flix-monkey
git rm docs/superpowers/specs/2026-07-12-api-clients-search-returns-title-design.md
git rm docs/superpowers/plans/2026-07-12-api-clients-search-returns-title.md
git commit -m "docs: remove implementation design and plan files
