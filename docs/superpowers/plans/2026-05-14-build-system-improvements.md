...
- [x] **Step 1: Enable sourcemaps for non-userscript targets**
...
- [x] **Step 2: Verify sourcemap generation**
...
- [x] **Step 1: Move `dotenv` to `devDependencies`**
      Move `"dotenv": "^17.4.2"` from `dependencies` to `devDependencies`.

- [x] **Step 2: Add `engines` field**
...
- [x] **Step 4: Verify `package.json` changes**
...
- [x] **Step 1: Full build and lint check**
