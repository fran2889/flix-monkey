...
- [ ] **Step 1: Simplify Cache key generation**
...
- [ ] **Step 1: Update `getData` signature**
...
- [ ] **Step 2: Update `api-manager` tests**
...
- [ ] **Step 1: Simplify `BaseApiClient` and implementations**
...
- [ ] **Step 2: Update API client tests**
...
- [ ] **Step 1: Remove year parsing logic**
      Remove the DOM year-parsing code in `src/core/surfaces.js`.

- [ ] **Step 2: Update calls to `ApiClientManager`**
