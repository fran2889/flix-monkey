...
> Browser extension and userscript that overlays IMDb, Rotten Tomatoes, and Metacritic ratings on Netflix thumbnails.
...
```
"Show IMDb, Rotten Tomatoes and Metacritic ratings on Netflix thumbnails"
```
...
```
FlixMonkey adds a ratings overlay from IMDb, Rotten Tomatoes, and Metacritic directly onto Netflix thumbnails, so you can decide what is worth watching without leaving the page.
