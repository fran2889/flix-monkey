...
Show IMDb, Metacritic, and Rotten Tomatoes ratings on Netflix thumbnails and banners

# full description

FlixMonkey overlays IMDb, Metacritic, and Rotten Tomatoes ratings onto Netflix thumbnails, hover cards, info panels, and search results, so you can tell what is worth watching at a glance. Fade out anything below a rating threshold you set, and jump straight to a title's IMDb page with one click.
