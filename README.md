...
See IMDb, Metacritic, and Rotten Tomatoes ratings while browsing Netflix, HBO Max, and Disney+.
...
- **Save**: Apply configuration changes and refresh applicable Netflix, HBO Max, and Disney+ tabs
...
3. Refresh the Netflix, HBO Max, or Disney+ page.
...
Netflix, HBO Max, or Disney+ may change its layout, breaking title discovery or rating badge positioning. A new FlixMonkey version may have introduced a bug.
...
- **Title lookups**: When you browse Netflix, HBO Max, or Disney+, the title names visible on the page are sent to third-party rating APIs (IMDb Suggestions, Agregarr, OMDb, and XMDb) solely to retrieve ratings. No account information, viewing history, Netflix credentials, HBO Max credentials, or Disney+ credentials are included in these requests.
